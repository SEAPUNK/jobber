...
// Returns:
//  Handler for job.
const createJob = copromise(function * createJob (api, name) {
  const jobId = yield api._server.createJob(name)
...
// (currently, it's rudimentary, with only name field supported)
